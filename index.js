...
// import { authenticationn } from './middleware/authenticationn'
...
// // Rutas
// app.get('/', authenticationn, async (req, res) => {
...
// app.get('/clientes', authenticationn, async (req, res) => {
...
// app.get('/ventas', authenticationn, async (req, res) => {
...
// app.get('/stock', authenticationn, async (req, res) => {
...
// app.get('/historial', authenticationn, async (req, res) => {
...
// app.get('/actualizar', authenticationn, async (req, res) => {
